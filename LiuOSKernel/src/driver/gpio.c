...
int gpio_pin_set_func(uint8_t pin_num, gpio_func func)
{
	...
	case 0:
		func_select_reg = (uint64_t)&kernel_gpio_base[GPFSEL0];
		break;
	case 1:
		func_select_reg = (uint64_t)&kernel_gpio_base[GPFSEL1];
		break;
	case 2:
		func_select_reg = (uint64_t)&kernel_gpio_base[GPFSEL2];
		break;
	case 3:
		func_select_reg = (uint64_t)&kernel_gpio_base[GPFSEL3];
		break;
	case 4:
		func_select_reg = (uint64_t)&kernel_gpio_base[GPFSEL4];
		break;
	case 5:
		func_select_reg = (uint64_t)&kernel_gpio_base[GPFSEL5];
		break;
	default:
...
int gpio_pin_set(uint8_t pin_num)
{
	...
	*/
	...
	{
	case 0:
		set_reg =  (uint64_t)&kernel_gpio_base[GPSET0];
		bit_start = pin_num;
		break;
	case 1:
		set_reg = (uint64_t)&kernel_gpio_base[GPSET1];
...
int gpio_pin_clear(uint8_t pin_num)
{
	...
	*/
	...
	{
	case 0:
		clr_reg = (uint64_t)&kernel_gpio_base[GPCLR0];
		bit_start = pin_num;
		break;
	case 1:
		clr_reg = (uint64_t)&kernel_gpio_base[GPCLR1];
		bit_start = (pin_num - 32);
		break;
	default:
		/* Not a valid GPIO PIN */
