...
enum
{
	IRQ0_PENDING_0     = (0x200), /*< ARM Core 0 IRQ Enabled Interrupt Pending bits [31:0]*/
	IRQ0_PENDING_1     = (0x204), /*< ARM Core 0 IRQ Enabled Interrupt pending bits [63:32] */
	IRQ0_PENDING_2     = ( 0x208), /*< ARM Core 0 IRQ Enabled Interrupt pending bits [79:64] */
	IRQ0_SET_EN_0      = (0x210), /*< Write to Set ARM Core 0 IRQ enable bits [31:0] */
	IRQ0_SET_EN_1      = (0x214), /*< Write to Set ARM Core 0 IRQ enable bits [63:32] */
	IRQ0_SET_EN_2      = (0x218), /*< Write to Set ARM Core 0 IRQ enable bits[79:64]*/ 
	IRQ0_CLR_EN_0      = (0x220), /*< Write to Clear ARM Core 0 IRQ enable bits [31:0] */
	IRQ0_CLR_EN_1      = (0x224), /*< Write to Clear ARM Core 0 IRQ enable bits [63:32]*/ 
	IRQ0_CLR_EN_2      = (0x228), /*< Write to Clear ARM Core 0 IRQ enable bits [79:64] */
